      ...
      <div className="home-container">
        ...
        <div className="sidebar">
          ...
          <div className="news-feed">
            ...
            <p><strong>July 2024:</strong> Our new book chapter on <a href="https://www.sciencedirect.com/science/article/abs/pii/B9780443159787000370?via%3Dihub" target="_blank" rel="noopener noreferrer">sample preparation and enrichment methods</a> in capillary electrophoresis applications has just been published!</p>
          </div>
        </div>
      </div>
    </div>
